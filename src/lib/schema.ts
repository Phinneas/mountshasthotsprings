const BASE_URL = "https://shastahotsprings.com";
...
export function buildOrganizationSchema() {
  return {
    ...
    sameAs: [
      "https://www.instagram.com/soakcolorados",
      "https://www.youtube.com/@soakcolorados",
    ],
  };
}
...
export function buildArticleSchema(
  ...
  const article: Record<string, any> = {
    ...
    dateModified,
    author: {
      "@type": authorName === "Shasta Hot Springs" ? "Organization" : "Person",
      name: authorName,
      url: `${BASE_URL}/authors/${typeof author === "object" && author?.id ? author.id : "shasta-hot-springs"}`,
    },
    publisher: {
      "@type": "Organization",
      name: "Shasta Hot Springs",
...
export function buildItemListSchema(
  ...
  return {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Hot Springs — Northern California, Oregon",
    description:
      "A comprehensive list of hot springs across Northern California and Oregon, including natural pools, resort soaks, and wilderness gems.",
    url: `${BASE_URL}/map`,
